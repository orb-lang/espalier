...
The [elpatt module](https://gitlab.com/special-circumstance/DEFAULT_PROJECT/) is intended to provide those
...
The case I'm interested in tackling directly is turning [LON data](https://gitlab.com/special-circumstance/br.lon/) directly into Lua tables, without bothering to pass through an
