...
I have yet to make this metacircular; what we see here is the raw LPEG
combinators in the familiar operator\-overloaded form\.
...
### Vav: A Parsing Expression Grammar for Parsing Expression Grammars

```lua
local function Vav(_ENV)
   START "rules"
   ---[[
