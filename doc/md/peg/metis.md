...
We should therefore be able to find locked rules which break the entire
grammar if they don't pass the gate\.
...
I think the basic structure of `rules`, `rule` \(maybe\) and `cat` are all
